...
export default function UserMenu() {
  ...
  const menuItems = [
    ...
    { icon: "M15.75 9V5.25A2.25 2.25 0 0 0 13.5 3h-6a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.25-2.25V15M12 9l-3 3m0 0 3 3m-3-3h12.75", label: "Logout" },
  ];
  ...
  return (
    <div className="relative">
      <button ref={buttonRef} onClick={() => setIsOpen(!isOpen)} className="flex items-center gap-2 px-3 py-2 hover:bg-neutral-800 rounded-lg transition-colors">
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="absolute right-0 mt-2 w-48 max-w-[calc(100vw-2rem)] bg-neutral-900 border border-neutral-800 rounded-lg shadow-xl overflow-hidden z-50"
          >
            {menuItems.map((item, idx) => (
              <button key={idx} className="w-full flex items-center gap-3 px-4 py-3 text-neutral-300 hover:bg-neutral-800 transition-colors text-sm">
